...
export default function ImageCarousel(): JSX.Element {
  return (
    <Carousel autoPlay interval={3000} infiniteLoop style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      <div style={{ width: '100%', height: '400px', position: 'relative' }}>
        <img src={m2} alt="Salon 1" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '8px' }} />
      ...
      <div style={{ width: '100%', height: '400px', position: 'relative' }}>
        <img src={salon2} alt="Salon 2" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '8px' }} />
      ...
      <div style={{ width: '100%', height: '400px', position: 'relative' }}>
        <img src={salon3} alt="Salon 3" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '8px' }} />
