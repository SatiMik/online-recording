...
import { deleteApplicationThunk } from '../../../redux/slices/application/ApplicationThunks';
...
export default function ApplicationCard({ application }: ApplicationItemTypeProps): JSX.Element {
    ...
    <Typography sx={{ mt: 1, fontSize: 20 }}>
        ...
        <Button variant="contained" onClick={() => void dispatch((deleteApplicationThunk({ id: application.id })))}>Принята</Button>
    </CardContent>
</Card>
    )
}
